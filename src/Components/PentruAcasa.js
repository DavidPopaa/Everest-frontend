...
const PentruAcasa = () => {
  ...
  useEffect(() => {
    const getAllData = async () => {
      try {
        const response = await fetch("https://everest-app-api.onrender.com/api/sell/pentruacasa");
  ...
  return (
    <div className="all-container">
      <div className="all-big-title">Pentru Acasa</div>
