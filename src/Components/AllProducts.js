...
const AllProducts = () => {
  ...
  useEffect(() => {
    const getAllData = async () => {
      try {
        const response = await fetch("https://everest-app-api.onrender.com/api/sell/getall");
  ...
  return (
    <div className="all-container">
      <div className="all-big-title">Toate produsele</div>
              ...
              <div key={item._id} className="all-parent-div">
                ...
                <div className="all-users">
                  ...
                  {item.asigned_users.map((single_user) => {
                    return <div className="userinscris">{single_user}</div>;
                  })}
                </div>
                <div></div>
